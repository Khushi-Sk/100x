export default function Search() {
    ...
    const base = "bg-searchbar-fill w-96 h-11 py-2.5 pr-60 pl-4 flex items-start rounded-full gap-3 hover:border focus-within:border-twitter-blue hover:border-twitter-blue-hover "
